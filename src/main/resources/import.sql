...
INSERT INTO users (username, password, role, is_account_non_locked, failed_attempts) VALUES ('user1', '$2a$10$ntppU9xAYFVuaocnAxtWWuguDhQq4zmdX03zUu2ALI6TWVT39yo/q', 'USER', true, 0);
INSERT INTO users (username, password, role, is_account_non_locked, failed_attempts) VALUES ('moderator1', '$2a$10$zxOV5jhRsC54gidl1OZ3aen8DwWhCQBWjUN.RyFbtL.bOcyXyJCaW', 'MODERATOR', true, 0);
INSERT INTO users (username, password, role, is_account_non_locked, failed_attempts) VALUES ('admin1', '$2a$10$.dui.4vqQHZT9RXHFDn0heUqHmdxTjyOt4pVyNca.eJ9EyG3MwVfC', 'SUPER_ADMIN', true, 0);
